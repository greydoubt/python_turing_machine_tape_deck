...
(loop i 
   ...
   (loop u r
      (check (in_it u "bad_xnu")
         (setq a (at u "bad_nlu"))
         (maybe (setq a (json_parse a)) (set@ u "bad_xnu" a) (λ (e_) (println "Errorr:" i)))))(push lst r))
...
(defun skip(code i)
   ...
   (if (not . in ligne "#")
      line
      (if (in (tokenize_rules parser_tok line) "#")
         (@@ line 0 "#")
         lignlinee)))
...
;  specific function to inject closing tags
;  transform Python into Lisp-like template
